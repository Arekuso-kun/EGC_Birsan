...
namespace Laborator__09
{
    public partial class Form1 : Form {
        ...
        private string fileVertex = locatieFisierSolutie + "\\Laborator #09\\vertexList.txt";
        private string fileQList = locatieFisierSolutie + "\\Laborator #09\\quadsVertexList.txt";
        private string fileTList = locatieFisierSolutie + "\\Laborator #09\\trianglesVertexList.txt";
        ...
        private void LoadTextures() {
            ...
            LoadTexture(textures[0], locatieFisierSolutie + "\\Laborator #09\\Resources\\brickTexture.jpg");
            LoadTexture(textures[1], locatieFisierSolutie + "\\Laborator #09\\Resources\\OpenGLTexture.png");
        }
        ...
        private void DeseneazaCilindru()
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
            ...
            // Definirea vârfurilor cilindrului
            int numSegments = 20;
            double radius = 60.0;
            double height = 60.0;
            ...
            {
                double theta1 = 2.0 * Math.PI * i / numSegments;
                double theta2 = 2.0 * Math.PI * (i + 1) / numSegments;

                double x1 = radius * Math.Cos(theta1);
                double z1 = radius * Math.Sin(theta1);

                double x2 = radius * Math.Cos(theta2);
                double z2 = radius * Math.Sin(theta2);

                // Vârfurile superioare ale cilindrului
                GL.TexCoord2(Math.Cos(theta1), Math.Sin(theta1));
                GL.Vertex3(x1, height, z1);

                GL.TexCoord2(Math.Cos(theta2), Math.Sin(theta2));
                GL.Vertex3(x2, height, z2);

                GL.TexCoord2(0.0, 0.0);
                GL.Vertex3(0.0, height, 0.0);

                // Vârfurile inferioare ale cilindrului
                GL.TexCoord2(Math.Cos(theta1), Math.Sin(theta1));
                GL.Vertex3(x1, 0.0, z1);

                GL.TexCoord2(Math.Cos(theta2), Math.Sin(theta2));
                GL.Vertex3(x2, 0.0, z2);

                GL.TexCoord2(0.0, 0.0);
                GL.Vertex3(0.0, 0.0, 0.0);

                // Laturile cilindrului
