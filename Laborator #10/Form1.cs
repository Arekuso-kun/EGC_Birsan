...
namespace Laborator__10
{
    public partial class Form1 : Form
    {
        ...
        private string fileVertex = locatieFisierSolutie + "\\Laborator #10\\vertexList.txt";
        private string fileQList = locatieFisierSolutie + "\\Laborator #10\\quadsVertexList.txt";
        private string fileTList = locatieFisierSolutie + "\\Laborator #10\\trianglesVertexList.txt";
        ...
        private void LoadTextures()
        {
            ...
            LoadTexture(textures[0], locatieFisierSolutie + "\\Laborator #10\\Resources\\brickTexture.jpg");
            LoadTexture(textures[1], locatieFisierSolutie + "\\Laborator #10\\Resources\\OpenGLTexture.png");
        }
        ...
        private void DeseneazaMinge()
        {
            ...
            switch (colorTex)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    GL.Color3(Color.FromArgb(255, 0, 0, 255));
                    break;
            }
            ...
            {
                double theta1 = i * 2.0 * Math.PI / slices;
                double theta2 = (i + 1) * 2.0 * Math.PI / slices;
                ...
                for (int j = 0; j < stacks; j++)
                {
                    ...
                    double x2 = radius * Math.Sin(phi2) * Math.Cos(theta1);
                    double y2 = radius * Math.Sin(phi2) * Math.Sin(theta1);
                    double z2 = radius * Math.Cos(phi2);

                    double x3 = radius * Math.Sin(phi2) * Math.Cos(theta2);
                    double y3 = radius * Math.Sin(phi2) * Math.Sin(theta2);
                    double z3 = radius * Math.Cos(phi2);


                    GL.Vertex3(x1, y1 + radius, z1);

                    GL.Vertex3(x2, y2 + radius, z2);

                    GL.Vertex3(x3, y3 + radius, z3);
                    ...
                    y2 = radius * Math.Sin(phi2) * Math.Sin(theta2);
                    z2 = radius * Math.Cos(phi2);

                    x3 = radius * Math.Sin(phi1) * Math.Cos(theta2);
                    y3 = radius * Math.Sin(phi1) * Math.Sin(theta2);
                    z3 = radius * Math.Cos(phi1);
